...
public class ForecastReturn  implements java.io.Serializable {
    ...
    private com.cdyne.ws.weatherws.ArrayOfForecast forecastResult;
    ...
    public ForecastReturn(
           ...
           com.cdyne.ws.weatherws.ArrayOfForecast forecastResult) {
        ...
        _equals = true && 
            ...
            ((this.forecastResult==null && other.getForecastResult()==null) || 
             (this.forecastResult!=null &&
              this.forecastResult.equals(other.getForecastResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getForecastResult() != null) {
            _hashCode += getForecastResult().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.cdyne.com/WeatherWS/", "ArrayOfForecast"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
