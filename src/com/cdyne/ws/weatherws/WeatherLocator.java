...
public class WeatherLocator extends org.apache.axis.client.Service implements com.cdyne.ws.weatherws.Weather {
    ...
    public com.cdyne.ws.weatherws.WeatherSoap_PortType getWeatherSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cdyne.ws.weatherws.WeatherSoap12Stub _stub = new com.cdyne.ws.weatherws.WeatherSoap12Stub(portAddress, this);
    ...
    public com.cdyne.ws.weatherws.WeatherSoap_PortType getWeatherSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cdyne.ws.weatherws.WeatherSoap_BindingStub _stub = new com.cdyne.ws.weatherws.WeatherSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cdyne.ws.weatherws.WeatherSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cdyne.ws.weatherws.WeatherSoap12Stub _stub = new com.cdyne.ws.weatherws.WeatherSoap12Stub(new java.net.URL(WeatherSoap12_address), this);
                _stub.setPortName(getWeatherSoap12WSDDServiceName());
                return _stub;
            }
            if (com.cdyne.ws.weatherws.WeatherSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cdyne.ws.weatherws.WeatherSoap_BindingStub _stub = new com.cdyne.ws.weatherws.WeatherSoap_BindingStub(new java.net.URL(WeatherSoap_address), this);
                _stub.setPortName(getWeatherSoapWSDDServiceName());
                return _stub;
            }
        }
